...
import { a as SelectTrigger, i as SelectItem, n as Select, o as SelectValue, r as SelectContent, t as CsvIO } from "./CsvIO-CP89IxcQ.js";
import { C as CommandList, D as DialogHeader, E as DialogFooter, O as DialogTitle, S as CommandItem, T as DialogContent, _ as PopoverTrigger, a as LocationPinPair, b as CommandGroup, c as basisRanges, g as PopoverContent, h as Popover, i as VEHICLE_CONFIG, m as fetchAll, o as useLocations, p as useBranches, r as TRANSPORTER_CONFIG, s as LocationPicker, t as DRIVER_CONFIG, u as rangeKey, v as Command, w as Dialog, x as CommandInput, y as CommandEmpty } from "./configs-B_ndUGt-.js";
import { useEffect, useMemo, useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { Archive, ArrowLeft, Check, ChevronRight, ChevronsUpDown, Loader2, Lock, Plus, RotateCcw, Route, Save, Search, Trash2, TrendingDown, TrendingUp, Truck } from "lucide-react";
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(Label, {
			...
			children: [/* @__PURE__ */ jsx(PopoverTrigger, {
				...
				align: "start",
				children: /* @__PURE__ */ jsxs(Command, { children: [/* @__PURE__ */ jsx(CommandInput, { placeholder: "Search…" }), /* @__PURE__ */ jsxs(CommandList, { children: [/* @__PURE__ */ jsx(CommandEmpty, { children: "Nothing found." }), /* @__PURE__ */ jsxs(CommandGroup, { children: [onAdd ? /* @__PURE__ */ jsxs(CommandItem, {
					value: "__add_new__",
					onSelect: () => {
						setOpen(false);
						onAdd();
					},
					children: [/* @__PURE__ */ jsx(Plus, { className: "size-4" }), /* @__PURE__ */ jsx("span", { children: addLabel ?? "Add new" })]
				}) : null, options.map((o) => /* @__PURE__ */ jsxs(CommandItem, {
					value: `${o.label} ${o.sub ?? ""}`,
					onSelect: () => {
						onChange(o.id);
						setOpen(false);
					...
					children: [
						/* @__PURE__ */ jsx(Check, { className: cn("size-4", value === o.id ? "opacity-100" : "opacity-0") }),
						/* @__PURE__ */ jsx("span", {
							className: "truncate",
							children: o.label
						}),
						o.sub ? /* @__PURE__ */ jsx("span", {
...
function TransporterQuickCreate({ open, onOpenChange, onCreated }) {
	const [form, setForm] = useState(Object.fromEntries(KEYS.map((k) => [k, ""])));
	...
	return /* @__PURE__ */ jsx(Dialog, {
		...
		children: /* @__PURE__ */ jsxs(DialogContent, {
			...
			children: [/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: "New transporter" }) }), /* @__PURE__ */ jsxs("form", {
				onSubmit: submit,
				className: "space-y-5",
				children: [FIELDS.map((section) => /* @__PURE__ */ jsxs("section", { children: [/* @__PURE__ */ jsx("h4", {
					className: "text-xs font-semibold uppercase tracking-[0.14em] text-muted-foreground",
					children: section.title
				}), /* @__PURE__ */ jsx("div", {
					className: "mt-3 grid grid-cols-1 gap-x-4 gap-y-3 sm:grid-cols-2",
					children: section.fields.map((f) => /* @__PURE__ */ jsxs("div", {
						...
						}), f.options ? /* @__PURE__ */ jsxs(Select, {
				...
				})] }, section.title)), /* @__PURE__ */ jsxs(DialogFooter, { children: [/* @__PURE__ */ jsx(Button, {
					type: "button",
					variant: "outline",
					...
					type: "submit",
					disabled: saving,
					children: [saving ? /* @__PURE__ */ jsx(Loader2, { className: "size-4 animate-spin" }) : null, "Save transporter"]
				})] })]
			})]
		})
	});
...
function TripForm({ initial, onBack, onSaved }) {
	...
	const [expenses, setExpenses] = useState(DEFAULT_EXPENSES.map((name) => ({
		name,
		amount: "",
		note: ""
	})));
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs(Button, {
						...
						size: "sm",
						onClick: onBack,
						children: [/* @__PURE__ */ jsx(ArrowLeft, { className: "size-4" }), "Back to trips"]
					}),
					/* @__PURE__ */ jsx("h2", {
					...
					/* @__PURE__ */ jsxs(Button, {
						...
						onClick: () => saveTrip(),
						disabled: saving,
						children: [saving ? /* @__PURE__ */ jsx(Loader2, { className: "size-4 animate-spin" }) : /* @__PURE__ */ jsx(Save, { className: "size-4" }), trip.id ? "Update trip" : "Save trip"]
					}),
					/* @__PURE__ */ jsxs(Button, {
						variant: "outline",
						onClick: handleClose,
						...
						children: [closing ? /* @__PURE__ */ jsx(Loader2, { className: "size-4 animate-spin" }) : /* @__PURE__ */ jsx(Lock, { className: "size-4" }), "Close trip"]
					})
				]
			}),
			/* @__PURE__ */ jsxs("form", {
				...
				children: [/* @__PURE__ */ jsx("h3", {
					...
					children: [
						...
						trip.ownership === "own" ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(EntityPicker, {
							label: "Vehicle",
							value: trip.vehicle_id,
							options: vehicleOpts,
							onChange: (id) => patch({ vehicle_id: id })
						}), /* @__PURE__ */ jsx(EntityPicker, {
							label: "Driver",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: TABS$1.map((t) => /* @__PURE__ */ jsx("button", {
						type: "button",
						onClick: () => setTab(t.id),
					...
					className: "p-6",
					children: [
						tab === "manifest" ? /* @__PURE__ */ jsx(ManifestTab, {
							tripId: trip.id ?? null,
							requireTripId,
							manifests,
							lines,
						...
						tab === "income" ? /* @__PURE__ */ jsx(LineTab, {
							title: "Other income",
						...
						tab === "expense" ? /* @__PURE__ */ jsx(LineTab, {
							title: "Expenses",
			...
			/* @__PURE__ */ jsx(TransporterQuickCreate, {
...
function ManifestTab({ tripId, requireTripId, manifests, lines, total, locations, reload }) {
	...
	const nameById = useMemo(() => new Map(locations.map((l) => [l.id, l.location_name])), [locations]);
	const idByName = useMemo(() => new Map(locations.map((l) => [l.location_name.toLowerCase(), l.id])), [locations]);
	const idByPin = useMemo(() => new Map(locations.filter((l) => (l.pin_code ?? "").trim() !== "").map((l) => [(l.pin_code ?? "").trim(), l.id])), [locations]);
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs(Button, {
					...
					size: "sm",
					onClick: openNew,
					children: [/* @__PURE__ */ jsx(Plus, { className: "size-4" }), "Create manifest"]
				}), /* @__PURE__ */ jsx("div", {
					className: "ml-auto",
					children: /* @__PURE__ */ jsx(CsvIO, {
			...
			manifests.length === 0 ? /* @__PURE__ */ jsx("p", {
				...
				children: /* @__PURE__ */ jsxs("table", {
					...
					}) }), /* @__PURE__ */ jsxs("tbody", { children: [lines.map((l) => {
			...
			/* @__PURE__ */ jsx(Dialog, {
				...
				children: /* @__PURE__ */ jsxs(DialogContent, {
					className: "max-h-[85vh] max-w-2xl overflow-y-auto",
					children: [/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: editing?.id ? "Edit manifest" : "New manifest" }) }), editing ? /* @__PURE__ */ jsxs("form", {
						onSubmit: save,
						...
						children: [
							...
							/* @__PURE__ */ jsxs(DialogFooter, {
								...
								children: [/* @__PURE__ */ jsx(Button, {
									...
									type: "submit",
									disabled: saving,
									children: [saving ? /* @__PURE__ */ jsx(Loader2, { className: "size-4 animate-spin" }) : null, "Save manifest"]
								})]
							})
						]
					}) : null]
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs(Button, {
						...
						children: [/* @__PURE__ */ jsx(Plus, { className: "size-4" }), "Add field"]
					}),
					/* @__PURE__ */ jsxs(Button, {
						type: "button",
						size: "sm",
						onClick: onSave,
						children: [/* @__PURE__ */ jsx(Save, { className: "size-4" }), "Save"]
					})
				]
			}),
			/* @__PURE__ */ jsx("div", {
...
function Details({ record, sections, empty }) {
	if (!record) return /* @__PURE__ */ jsx("p", {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: sections.map((s) => {
			...
			return /* @__PURE__ */ jsxs("section", { children: [/* @__PURE__ */ jsx("h4", {
				className: "text-xs font-semibold uppercase tracking-[0.14em] text-muted-foreground",
				children: s.title
			}), /* @__PURE__ */ jsx("dl", {
				className: "mt-2 grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-2",
				children: filled.map((f) => /* @__PURE__ */ jsxs("div", {
...
function ContractDetails({ contract, entryCount, monthlyCharges }) {
	if (!contract) return /* @__PURE__ */ jsx("p", {
		className: "text-sm text-muted-foreground",
	...
	return /* @__PURE__ */ jsx("dl", {
		...
		].filter(([, v]) => v.trim() !== "").map(([k, v]) => /* @__PURE__ */ jsxs("div", {
			className: "flex justify-between gap-4 text-sm",
			children: [/* @__PURE__ */ jsx("dt", {
				className: "text-muted-foreground",
				children: k
...
function Trips() {
	...
	if (editing) return /* @__PURE__ */ jsx(TripForm, {
		initial: editing,
		onBack: () => {
			setEditing(null);
			load();
		...
		children: [
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs(Button, {
					...
					children: [/* @__PURE__ */ jsx(Plus, { className: "size-4" }), "New trip"]
				})
			}),
			loading ? /* @__PURE__ */ jsxs("div", {
				className: "space-y-2",
				children: [/* @__PURE__ */ jsx(Skeleton, { className: "h-16 w-full" }), /* @__PURE__ */ jsx(Skeleton, { className: "h-16 w-full" })]
			}) : trips.length === 0 ? /* @__PURE__ */ jsx("p", {
				...
				children: trips.map((t) => /* @__PURE__ */ jsxs("li", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs(Button, {
							...
							children: [/* @__PURE__ */ jsx(Lock, { className: "size-4" }), "Close"]
						})
					]
				}, t.id))
			}),
			closed.length > 0 ? /* @__PURE__ */ jsxs("section", {
				className: "space-y-2 pt-4",
				children: [
					/* @__PURE__ */ jsxs("h3", {
						className: "flex items-center gap-2 text-sm font-semibold tracking-tight",
						children: [/* @__PURE__ */ jsx(Archive, { className: "size-4 text-muted-foreground" }), "Closed trips"]
					}),
					/* @__PURE__ */ jsx("p", {
					...
					/* @__PURE__ */ jsx("ul", {
						className: "space-y-2",
						children: closed.map((c) => /* @__PURE__ */ jsxs("li", {
							className: "surface-card flex items-center gap-3 p-4",
							children: [
								/* @__PURE__ */ jsx(Archive, { className: "size-4 text-muted-foreground" }),
								/* @__PURE__ */ jsxs("div", {
								...
								/* @__PURE__ */ jsxs(Button, {
									...
									onClick: () => reopen(c.id),
									children: [/* @__PURE__ */ jsx(RotateCcw, { className: "size-4" }), "Reopen"]
								})
							]
						}, c.id))
					})
...
function FinanceList({ kind }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			loading ? /* @__PURE__ */ jsxs("div", {
				className: "space-y-2",
				children: [/* @__PURE__ */ jsx(Skeleton, { className: "h-14 w-full" }), /* @__PURE__ */ jsx(Skeleton, { className: "h-14 w-full" })]
						...
						return /* @__PURE__ */ jsxs("tr", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("td", {
									...
									children: [
										!r.settled ? /* @__PURE__ */ jsxs(Button, {
											variant: "outline",
											size: "sm",
											onClick: () => settle(r),
											children: [/* @__PURE__ */ jsx(Check, { className: "size-4" }), cfg.actionLabel]
										}) : null,
										/* @__PURE__ */ jsx(Button, {
											variant: "ghost",
											size: "sm",
			...
			/* @__PURE__ */ jsx(Dialog, {
				...
				children: /* @__PURE__ */ jsxs(DialogContent, {
					className: "max-h-[85vh] max-w-2xl overflow-y-auto",
					children: [/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: editing?.id ? `Edit ${cfg.single}` : `New ${cfg.single}` }) }), editing ? /* @__PURE__ */ jsxs("form", {
						onSubmit: save,
						className: "grid grid-cols-1 gap-x-4 gap-y-3 sm:grid-cols-2",
						children: [
							/* @__PURE__ */ jsxs("div", {
							...
							/* @__PURE__ */ jsxs(DialogFooter, {
								...
								children: [/* @__PURE__ */ jsx(Button, {
									...
									type: "submit",
									disabled: saving,
									children: [saving ? /* @__PURE__ */ jsx(Loader2, { className: "size-4 animate-spin" }) : null, "Save"]
								})]
							})
						]
					}) : null]
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("nav", {
				...
				children: [/* @__PURE__ */ jsx("p", {
					...
					children: TABS.map((t) => {
						...
						return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsx(Icon, { className: `size-4 ${isActive ? "text-primary" : ""}` }), /* @__PURE__ */ jsxs("span", {
				...
				children: [
					...
					tab === "trip" ? /* @__PURE__ */ jsx(Trips, {}) : null,
					tab === "income" ? /* @__PURE__ */ jsx(FinanceList, { kind: "income" }) : null,
					tab === "expenditure" ? /* @__PURE__ */ jsx(FinanceList, { kind: "expenditure" }) : null
				]
			}, tab)]
		})
	});
}
var SplitComponent = () => /* @__PURE__ */ jsx(RequireAuth, { children: /* @__PURE__ */ jsx(OperationsPage, {}) });
//#endregion
