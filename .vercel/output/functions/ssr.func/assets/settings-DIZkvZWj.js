...
import { r as useTheme, t as THEMES } from "./theme-9ALIvQOb.js";
...
import { ArrowLeft, Building, Building2, Check, ChevronRight, Loader2, Palette, Plus, Save, Trash2 } from "lucide-react";
...
function CompanySettings() {
	...
	if (loading) return /* @__PURE__ */ jsx("div", {
		className: "space-y-5",
		children: Array.from({ length: 3 }).map((_, i) => /* @__PURE__ */ jsx(Skeleton, { className: "h-64 rounded-2xl" }, i))
	});
		...
		children: [
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(Label, {
							...
							}), /* @__PURE__ */ jsx(SelectContent, { children: COMPANY_TYPES.map((t) => /* @__PURE__ */ jsx(SelectItem, {
								value: t,
								children: t
							}, t)) })]
						})]
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs(Button, {
					...
					disabled: saving,
					className: "h-10",
					children: [saving ? /* @__PURE__ */ jsx(Loader2, { className: "size-4 animate-spin" }) : /* @__PURE__ */ jsx(Save, { className: "size-4" }), saving ? "Saving…" : "Save company details"]
				})
			})
		]
	});
		...
		children: [
				...
				children: [/* @__PURE__ */ jsx(Field, {
					...
					children: [/* @__PURE__ */ jsx(Label, {
						...
						children: [/* @__PURE__ */ jsx(SelectTrigger, {
							className: "h-10 w-full",
							children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select type" })
						}), /* @__PURE__ */ jsx(SelectContent, { children: BRANCH_TYPES.map((t) => /* @__PURE__ */ jsx(SelectItem, {
							value: t,
							children: t
						}, t)) })]
					})]
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Button, {
					...
					disabled: saving,
					className: "h-10",
					children: [saving ? /* @__PURE__ */ jsx(Loader2, { className: "size-4 animate-spin" }) : /* @__PURE__ */ jsx(Save, { className: "size-4" }), saving ? "Saving…" : "Save branch"]
				})]
			})
		]
	});
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
				...
				children: [/* @__PURE__ */ jsx(CsvIO, {
					...
					children: [/* @__PURE__ */ jsx(Plus, { className: "size-4" }), "New branch"]
				})]
			})]
			...
			children: [
				/* @__PURE__ */ jsx("span", {
					...
					children: /* @__PURE__ */ jsx(Building2, { className: "size-6" })
				}),
				/* @__PURE__ */ jsx("p", {
			...
			className: "space-y-3",
			children: branches.map((b, i) => /* @__PURE__ */ jsxs("li", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("nav", {
				...
				children: [
					...
					tab === "company" ? /* @__PURE__ */ jsx(CompanySettings, {}) : null,
					tab === "branch" ? /* @__PURE__ */ jsx(BranchSettings, {}) : null,
					tab === "theme" ? /* @__PURE__ */ jsx(ThemePanel, {}) : null
				]
			}, tab)]
		})
	});
					...
					children: THEMES.map((t) => {
						...
						return /* @__PURE__ */ jsxs("button", {
							...
							children: [
								...
								isActive ? /* @__PURE__ */ jsx(Check, { className: "absolute right-3 top-3 size-4 text-primary" }) : null
							]
						}, t.id);
					})
				})
...
var SplitComponent = () => /* @__PURE__ */ jsx(RequireAuth, { children: /* @__PURE__ */ jsx(SettingsPage, {}) });
//#endregion
