-- Accounts > Masters: branch-linked bank and cash accounts.
...
-- Keep updated_at correct for edits made outside the UI.
...
create policy "accounts bank anon and authenticated access" on public.bank_accounts
for all to anon, authenticated using (true) with check (true);

drop policy if exists "accounts cash anon and authenticated access" on public.cash_accounts;
create policy "accounts cash anon and authenticated access" on public.cash_accounts
for all to anon, authenticated using (true) with check (true);
