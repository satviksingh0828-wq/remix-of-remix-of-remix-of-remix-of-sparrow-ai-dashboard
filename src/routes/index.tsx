...
function LoginPage() {
  ...
  return (
    ...
    <div className="grid min-h-[calc(100dvh/var(--app-zoom))] overflow-x-hidden lg:grid-cols-[1.05fr_1fr]">
      {/* Banner — switches between plain gradient and image based on Settings */}
      {loginUi === "image" ? (
        <aside className="relative hidden min-h-[calc(100dvh/var(--app-zoom))] overflow-hidden lg:block">
        ...
        <aside
          className="relative hidden min-h-[calc(100dvh/var(--app-zoom))] items-center justify-center overflow-hidden px-12 lg:flex"
      ...
      {/* Login */}
      <section className="relative flex min-h-[calc(100dvh/var(--app-zoom))] min-w-0 flex-col items-center justify-center bg-background px-6 py-10">
